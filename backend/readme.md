...
The `data` directory in this repository contains a sqlite database for you to work from. You're free to modify the database schema however you like or use a different database if you prefer.

The raw data was downloaded as CSV files from https://datasf.org:
...
You can rebuild this sqlite database by running:
...
.import ./data/Electrical_Permits.csv permits
.import ./data/Electrical_Permits_Contacts.csv contacts
.import ./data/Fire_Violations.csv fire_violations
